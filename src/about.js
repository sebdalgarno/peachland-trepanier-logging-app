...
export const tips =
  "To decrease/increase years either click the +/- buttons on either side of the year, move the time slider, or click on the time slider and then use left/right arrow keys. Use mouse to adjust zoom (scroll) and pan of map. Logged area shapes have been simplified at initial zoom level to improve rendering time. To see shapes at original resolution, zoom in until more details emerge.";
